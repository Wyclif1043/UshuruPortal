...
const LandTransactionReport = () => {
  ...
  const generateReport = async (shouldAutoDownload = autoDownload) => {
    ...
    try {
      ...
      const apiUrl = `http://88.99.215.90:8001/api/land-transaction-report/?member_no=${memberNo}`;
  ...
  const directDownload = () => {
    ...
    const memberNo = memberNumber.trim();
    const url = `http://88.99.215.90:8001/api/land-transaction-report/?member_no=${memberNo}`;
