...
const ChangePin = () => {
  ...
  useEffect(() => {
    // Get ID number from localStorage (which is the username for SOAP API)
    const storedIdNo = localStorage.getItem('tempIdNo');
    if (!storedIdNo) {
      navigate('/register');
      return;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/change-password/`, {
        ...
        body: JSON.stringify({
          id_number: idNo, // This will be used as username in the backend
          current_pass: formData.currentPin,
          new_pass: formData.newPin
        }),
      });
      ...
      if (response.ok) {
        ...
        localStorage.removeItem('tempIdNo');
        ...
        setError(data.error || 'Failed to change PIN. Please try again.');
      }
    } catch (err) {
  ...
  return (
    <div className="login-container">
      ...
      >
        ...
        <div className="brand-content">
          ...
          <p className="brand-tagline">
            Set your secure PIN for accessing the member portal
          </p>
          ...
          <div className="benefits-section">
            <div className="benefit-item">
              ...
              <span className="benefit-text">Choose a memorable 4-digit PIN</span>
            </div>
            ...
            <div className="benefit-item">
              ...
              <span className="benefit-text">Do not share your PIN with anyone</span>
            </div>
            ...
            <div className="benefit-item">
              ...
              <span className="benefit-text">Change your PIN regularly for security</span>
            </div>
          </div>
          ...
          <div className="mobile-benefits">
            <div className="mobile-benefit-grid">
              <div className="mobile-benefit">
                ...
                <span className="mobile-benefit-label">Secure</span>
              </div>
              <div className="mobile-benefit">
                <div 
                  className="mobile-benefit-icon"
                ...
                <span className="mobile-benefit-label">Private</span>
              </div>
              <div className="mobile-benefit">
                <div 
                  className="mobile-benefit-icon"
                ...
                <span className="mobile-benefit-label">Update</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Right Section - Change PIN Form */}
      <div className="form-section">
        <div className="form-container">
          {/* Mobile Header */}
          <div className="mobile-header">
            <h2 className="form-title-mobile">Set Your PIN</h2>
            <p className="form-subtitle-mobile">Create a secure PIN for your account</p>
          </div>

          {/* Desktop Header */}
          <div className="desktop-header">
            <h2 className="form-title">Set Your PIN</h2>
            <p className="form-subtitle">Create a secure PIN for your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="registration-form">
            <div className="form-group">
              ...
              <input
                ...
                required
                maxLength="4"
                placeholder="Enter temporary PIN from SMS"
