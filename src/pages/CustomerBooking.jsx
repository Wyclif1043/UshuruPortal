...
const CustomerBooking = () => {
  ...
  const loadPlots = async (landCode) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        const availablePlots = data.plots.filter(plot => 
          plot.plot_status?.toLowerCase() === 'available'
        );
        
        setPlots(availablePlots);
      } else {
        setError('Failed to load plots for this land');
      }
    } catch (err) {
      console.error('Error loading plots:', err);
      setError('Error loading plots. Please try again.');
    } finally {
          ...
          <div className="customer-info-card">
            ...
            <div className="customer-details">
              ...
              <div className="booking-step">
                {activeTab === 'lands' ? 'Select a land to view available plots' : 'Select a plot to book'}
              </div>
            </div>
          </div>
        </div>
          ...
          {activeTab === 'booking' && selectedLand && (
            <div className="booking-section">
              <div className="booking-header">
                <button onClick={handleBackToLands} className="back-button">
                  <i className="fas fa-arrow-left"></i>
                  Back to Lands
                </button>
                <h2>Available Plots in {selectedLand.Description}</h2>
              </div>
              ...
              {plotsLoading ? (
                ...
                <CustomerPlotBooking 
                  ...
                  onBack={handleBackToLands}
                />
              ) : (
                <div className="empty-state">
                  <i className="fas fa-map-marked-alt"></i>
                  <h3>No Plots Available</h3>
                  <p>There are currently no available plots in this land.</p>
                  <button onClick={handleBackToLands} className="primary-button">
                    <i className="fas fa-arrow-left"></i>
                    Back to Lands
                  </button>
                </div>
